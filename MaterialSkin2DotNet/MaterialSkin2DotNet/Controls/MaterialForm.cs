...
namespace MaterialSkin2DotNet.Controls
{
    ...
    public class MaterialForm : Form, IMaterialControl
    {
        ...
        public Primary _primaryColor = Primary.Indigo400;
        public Primary _primaryDarkColor = Primary.Indigo700;
        public Primary _primaryLightColor = Primary.Indigo100;
        public Accent _accentColor = Accent.Pink200;
        ...
        public ColorScheme defaultCS = new ColorScheme(Primary.Green400, Primary.Green700, Primary.Green100, Accent.LightBlue200, TextShade.WHITE);

        public ColorScheme formPC
        {
            get; set;
        }
        ...
        public MaterialForm FormToManage
        {
            ...
            set
            {
                ...
                if (value != null)
                {
                    SkinManager.AddFormToManage(value);
                    Invalidate();
                }
                else
                {
                    SkinManager.RemoveFormToManage(_materialForm);
                    value = null;
                    Invalidate(invalidateChildren: true);
                    Invalidate(invalidateChildren: true);
                }
