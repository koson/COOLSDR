...
namespace Thetis
{
    public partial class ucInfoBar : UserControl
    {
       ...
       // private frmInfoBarPopup _frmInfoBarPopup_Button2;
        ...
        public static Label UnknownLabel
        {
            get
            {
                Debug.Assert(false);
        ...
        public void LateInit(FrmMain c)
        {
            _console = c;
        ...
        public CheckBox GetPopupButton(int infoBarButton, int index)
        {
            /*/
            if(infoBarButton == 1)
            {
