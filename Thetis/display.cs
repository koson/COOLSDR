...
namespace Thetis
{
    class Display
    {
        ...
        private static bool m_bShowFPS = true;
        ...
        public static DisplayMode CurrentDisplayMode
        {
            ...
            set
            {
                ...
                if (console.PowerOn) console.DisplayHelper.Pause_DisplayThread = true;
                ...
                console.DisplayHelper.Pause_DisplayThread = false;
            }
        }
        ...
        // private static bool m_bLSB = false; // ke9ns add true=LSB, false=Protocol1
            ...
            bool bIsWaterfall = false)
        {
            ...
            {
                foreach (Channel c in FrmMain.Channels60m)
                {
            ...
            if (!bIsWaterfall && !local_mox)
            {
                            ...
                            && rx == 2)))
                {
                    ...
                    if (rx == 1 /* && !local_mox*/)
                    {
                        ...
                        int rx1_agc_fixed_gain = console.AGCFixedGain;
                        string rx1_agc = "";
                        switch (console.RX1AGCMode)
                        {
                            case AGCMode.FIXD:
                    ...
                    else if (rx == 2 /* && !local_mox*/)
                    {
                        ...
                        rx2_agc_fixed_gain = console.AGCRX2FixedGain;
        ...
        public static void ShutdownDX2D()
        {
            ...
            while (dx_running)
            {
                ...
                if (slept > 1000)
                {
                    Debug.Assert(false); // why didn't we close in a timely fashion?
                    break;
                }
            }
                ...
                lock (m_objDX2Lock)
                {
                    ...
                    if (FrameRateIssue)
                        d2dRenderTarget.FillRectangle(
                            new RectangleF(40, 0, 15, 15), m_bDX2_Red);
                    ...
                    if (m_bShowFPS)
                    {
                        d2dRenderTarget.DrawText(m_nFps.ToString(),
                            fontDX2d_callout,
                            new RectangleF(40, 0, float.PositiveInfinity,
        ...
        private static void calcFps()
        {
            ...
            m_nFrameCount++;
            if (t >= m_fLastTime + 1000 && m_nFrameCount >= 50)
            {
                double late = t - (m_fLastTime + 1000);
                if (late > 2000 || late < 0) late = 0; // ignore if too late
                m_nFps = m_nFrameCount;
                int wanted = (int)DisplayHelper.DisplayFPS;
                if (m_nFps < wanted - 1) // allow for rounding errors
                {
                    ...
                    else // if (rx == 2)
                    {
                            ...
                            default:
                                    ...
                                    && console.RX2AGCMode != AGCMode.FAST)
                                {
                                    ...
                                    drawLineDX2D(m_bDX2_Yellow, x3_rx2_hang,
                                        rx2_agc_hang_y, x2_rx2_hang,
                                        rx2_agc_hang_y, m_styleDots);
                                    //}
                                    // else
                                    //{
                                    //    drawLineDX2D(m_bDX2_Yellow, x3_rx2_hang,
                        ...
                        if (display_rx2_gain_line)
                        {
                            ...
                            drawLineDX2D(m_bDX2_YellowGreen, x1_rx2_gain,
                                rx2_agcknee_y_value, x2_rx2_gain,
                                rx2_agcknee_y_value, m_styleDots);
                            //}
                            // else
                            //{
                            //    drawLineDX2D(m_bDX2_YellowGreen, x1_rx2_gain,
