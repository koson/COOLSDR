namespace Thetis
{
    ...
    public enum HPSDRHW
    {
        ...
        Atlas = 0,
        Hermes = 1,
        HermesII = 2, // ANAN-10E ANAN-100B HermesII
        Angelia = 3,  // ANAN-100D
        Orion = 4,    // ANAN-200D
        OrionMKII = 5, // ANAN-7000DLE 7000DLEMkII ANAN-8000DLE OrionMkII
        HermesLite = 6
    }

    class EnumStrings
    {
        public static string HPSDRHWToString(HPSDRHW h)
        {
            string ret = "";
            switch (h)
            {
                case HPSDRHW.Unknown: ret = "Unknown"; break;
                case HPSDRHW.Atlas: ret = "Atlas"; break;
                case HPSDRHW.Angelia: ret = "Angelia (ANAN-100D)"; break;
                case HPSDRHW.Orion: ret = "Orion (ANAN-200D)"; break;
                case HPSDRHW.Hermes: ret = "Hermes"; break;
                case HPSDRHW.HermesII: ret = "HermesII (ANAN-10E, ANAN-100B)"; break;
                case HPSDRHW.OrionMKII: ret = "OrionMKII (ANAN-7000DLE, ANAN-8000DLE)"; break;
                case HPSDRHW.HermesLite: ret = "HermesLite"; break;
                default:
                    int n = (int)h;
                    ret = "Unknown [" + n.ToString() + "]"; break;
            }
            return ret;
        }
    }
    ...
    {
        Protocol1 = 0,  // Protocol Protocol1 (P1) (was USB)
        Protocol2,      // Protocol Protocol2 (P2) (was ETH)
        Auto,
        None,
        LAST
    }
