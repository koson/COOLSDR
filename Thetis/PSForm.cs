...
namespace Thetis
{
    public unsafe partial class PSForm : Form
    {
        ...
        private FrmMain console;

        public PSForm(FrmMain c)
        {
            InitializeComponent();
            ...
            FormPos = new FormPosition(this);

        }

        public FormPosition FormPos
        {
            get;
            private set;
        }
...
#pragma warning restore CS0169 // The field 'PSForm.red' is never used
        ...
        public bool AutoAttenuate
        {
            ...
            set
            {
                ...
                else
                {
                    ...
                    {
                        console.ATTOnTX = console.ATTOnTXChecked;
                    }
                    else
                    {
                        console.ATTOnTX = autoattenuate;
        ...
        public bool SinglecalON { get => singlecalON; set => singlecalON = value; }
        public bool RestoreON { get => restoreON; set => restoreON = value; }
        ...
        private void btnPSTwoToneGen_Click(object sender, EventArgs e)
        {
            if (ttgenON == false)
            {
                btnPSTwoToneGen.BackColor = Color.FromArgb(gcolor);
                ttgenON = true;
                console.TTgenrun = true;
            }
            else
            {
                btnPSTwoToneGen.BackColor = SystemColors.Control;
                ttgenON = false;
                console.TTgenrun = false;
            }
        }
            ...
            switch (aastate)
            {
                case 0: // monitor
                    if (autoattenuate && puresignal.CalibrationAttemptsChanged
                        && puresignal.NeedToRecalibrate(console.ATTONTX))
                    {
                ...
                case 1: // set new values
                    aastate = 2;
                    if ((console.ATTONTX + deltadB) > 0)
                        console.ATTONTX += deltadB;
                    else
                        console.ATTONTX = 0;
                    break;
    ...
    unsafe static class puresignal
    {
        ...
        public static void GetInfo(int txachannel)
        {
            ...
            // this is failing for KLJ on my ARM Win11
