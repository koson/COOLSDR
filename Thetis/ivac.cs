namespace Thetis
{
    ...
    unsafe class ivac
    {
        ...
        //PORT PaStreamInfo GetStreamIVAC(int id);
        [DllImport("ChannelMaster.dll", EntryPoint = "GetStreamIVAC", CallingConvention = CallingConvention.Cdecl)] // StartAudioVAC()
        public static extern PaStreamInfo GetStreamIVAC(int id);
