...
namespace Thetis
{
    public class PortAudioForCoolSDR
    {
        #region Constants
        public const UInt32 paFloat64 = ((PaSampleFormat)0x00000001);
        public const UInt32 paFloat32 = ((PaSampleFormat)0x00000002);
        public const UInt32 paInt32 = ((PaSampleFormat)0x00000004);
        public const UInt32 paInt24 = ((PaSampleFormat)0x00000008);
        public const UInt32 paInt16 = ((PaSampleFormat)0x00000010);
        public const UInt32 paInt8 = ((PaSampleFormat)0x00000020);
        public const UInt32 paUInt8 = ((PaSampleFormat)0x00000040);
        public const UInt32 paCustomFormat = ((PaSampleFormat)0x00010000);
        public const UInt32 paNonInterleaved = ((PaSampleFormat)0x80000000);
        ...
        public struct PaDeviceInfo
        {
            ...
            public PaHostApiIndex hostApiIndex;
...
#pragma warning disable CS0414 // The field 'PortAudioForCoolSDR.PaNoError' is assigned but its value is never used
        static readonly int PaNoError = 0;
#pragma warning restore CS0414 // The field 'PortAudioForCoolSDR.PaNoError' is assigned but its value is never used
