...
void StopReadThread(void) {
    ...
    DeInitMetisSockets(); // KLJ: I assume this is common to P1 and P2
}
...
// Protocol2 -- Protocol1 uses MetisReadThreadMainLoop(networkproto1.c)
...
// #define NET_DEBUG_KLJ_LAGS
// #define KLJ_DEBUG_THREAD
...
#ifdef KLJ_DEBUG_THREAD
    volatile int pri = GetThreadPriority(GetCurrentThread());
    pri++;
#endif
#ifdef NET_DEBUG_KLJ_LAGS
...
#endif
        static const int MYTIMEOUT = 20000;
        if (ret == -1) {
